...
enum : std::uint16_t
{
    ...
    { \
        ...
        Wrum::Logger::GetInstance().Log(std::move(buffer), Wrum::LogVerbosity::Error, __VA_ARGS__); \
    }
    ...
    { \
        ...
        Wrum::Logger::GetInstance().Log(std::move(buffer), Wrum::LogVerbosity::Warning, __VA_ARGS__); \
    }
    ...
    { \
        ...
        Wrum::Logger::GetInstance().Log(std::move(buffer), Wrum::LogVerbosity::Message, __VA_ARGS__); \
    }
